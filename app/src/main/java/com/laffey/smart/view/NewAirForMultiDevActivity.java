...
public class NewAirForMultiDevActivity extends DetailActivity {
    ...
    protected boolean updateState(ETSL.propertyEntry propertyEntry) {
        ...
        // 风速
        if (propertyEntry.getPropertyValue(CTSL.FSS_WindSpeed_3) != null && propertyEntry.getPropertyValue(CTSL.FSS_WindSpeed_3).length() > 0) {
            String windSpeed = propertyEntry.getPropertyValue(CTSL.FSS_WindSpeed_3);
    ...
    protected void onViewClicked(View view) {
        if (view.getId() == R.id.low_wind_layout) {
            // 低风
            if (mPowerSwitch == 4)
                mTSLHelper.setProperty(mIOTId, mProductKey, new String[]{CTSL.FSS_WindSpeed_3}, new String[]{"" + 2});
        } else if (view.getId() == R.id.mid_wind_layout) {
            // 中风
            if (mPowerSwitch == 4)
                mTSLHelper.setProperty(mIOTId, mProductKey, new String[]{CTSL.FSS_WindSpeed_3}, new String[]{"" + 3});
        } else if (view.getId() == R.id.high_wind_layout) {
            // 高风
            if (mPowerSwitch == 4)
                mTSLHelper.setProperty(mIOTId, mProductKey, new String[]{CTSL.FSS_WindSpeed_3}, new String[]{"" + 4});
