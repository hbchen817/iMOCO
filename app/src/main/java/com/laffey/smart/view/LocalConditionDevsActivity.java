    ...
    private void initRecyclerView() {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                ...
                LocalIdentifierListActivity.start(LocalConditionDevsActivity.this, entry.nickName, entry.iotId, entry.deviceName, entry.productKey);
            }
        });
                ...
                if (msg.what == Constant.MSG_CALLBACK_GETGATEWAYSUBDEVICTLIST) {
                    ...
                    if (list != null && list.data != null) {
                        for (EUser.deviceEntry e : list.data) {
                            ...
                            entry.image = e.image;
                            activity.mGatewayDevs.add(entry);
                        }
