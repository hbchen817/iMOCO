...
public class EditLocalSceneBindActivity extends BaseActivity {
    ...
    public static void start(Context context, String title, String iotId, String keyCode, String sceneName, String gwId, String gwMac, String sceneId) {
        Intent intent = new Intent(context, EditLocalSceneBindActivity.class);
