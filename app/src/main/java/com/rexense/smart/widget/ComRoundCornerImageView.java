 ...
 * Description: 圆角图片控件
 */
public class ComRoundCornerImageView extends AppCompatImageView {
	...
	public ComRoundCornerImageView(Context context) {
		this(context, null);
		init(context, null);
	}

	public ComRoundCornerImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		init(context, attrs);
	}

	public ComRoundCornerImageView(Context context, AttributeSet attrs, int defStyleAttr) {
