...
public class Constant {
    // 包名
    public static String PACKAGE_NAME                                 = "com.rexense.smart";
    // 平台 plantForm
    ...
    // 正式环境APPKEY
    public static final String APPKEY                               = "33406019";
    public static final String APPSECRET                            = "83ea3749a36d85ac2882433105b5ddfb";

    // 本地服务appkey
    public static final String APP_KEY                              = "qerTUkdd";
    public static final String CLIENT_ID                            = "rwN8MmzL";// 自有账号体系-飞燕设置
    public static final String PROJECT_ID                           = "a123Q0oxSGo3o0Q7";//拉斐-飞燕项目ID
