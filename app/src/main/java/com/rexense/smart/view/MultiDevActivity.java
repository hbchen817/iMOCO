...
public class MultiDevActivity extends DetailActivity {
    ...
    protected void onViewClicked(View view) {
        ...
        if (resId == R.id.scene_layout) {
            ...
            // 空调
            Intent intent = new Intent(mActivity, AirConditionerForMultiDevActivity.class);
            intent.putExtra("iotId", mIOTId);
            ...
            // 地暖
            Intent intent = new Intent(mActivity, FloorHeatingForMultiDevActivity.class);
            intent.putExtra("iotId", mIOTId);
            intent.putExtra("productKey", CTSL.PK_MULTI_THREE_IN_ONE);
