...
import com.rexense.smart.contract.CBLE;
import com.rexense.smart.contract.Constant;
import com.rexense.smart.databinding.ActivityConfigurenetworkBinding;
import com.rexense.smart.event.RefreshData;
import com.rexense.smart.model.EConfigureNetwork;
import com.rexense.smart.presenter.ConfigureNetwork;
import com.rexense.smart.presenter.SystemParameter;
import com.rexense.smart.presenter.UserCenter;
import com.rexense.smart.utility.BLEService;
...
import com.rexense.smart.utility.WiFiHelper;
...
public class ConfigureNetworkActivity extends BaseActivity {
    ...
    protected void notifyFailureOrError(int type) {
        ...
        if (mIotId != null && mIotId.length() > 0 && devName != null && devName.length() > 0) {
            BindSuccessActivity.start(this, mIotId, mIotId, getIntent().getStringExtra("name"), mProductKey);
            finish();
        }
    }
    ...
    private static class ApiDataHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.what == Constant.MSG_CALLBACK_GET_BY_ACCOUNT_AND_DEV) {
                ...
                BindSuccessActivity.start(activity, object.getString("iotId"), object.getString("iotId"), object.getString("productName"), activity.mProductKey);
                activity.finish();
            }
        }
    }
