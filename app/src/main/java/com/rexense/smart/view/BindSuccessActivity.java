...
import com.rexense.smart.databinding.ActivityBindSuccessBinding;
...
public class BindSuccessActivity extends BaseActivity {
    ...
    public void onViewClicked(View view) {
        ...
        if (id == R.id.iv_toolbar_left) {
            ...
            if (mProductKey == null) {
                ...
                ActivityRouter.toDetail(this, mIotId, mProductKey,
    ...
    public static void start(Context context, String gatewayId, String iotId, String nickName, String productKey) {
    ...
    // 网关绑定到项目
    private void gwBindToProject() {
        DeviceManager.gwBindToProject(this, mProductKey, mDeviceName, new DeviceManager.Callback() {
            @Override
