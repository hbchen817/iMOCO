...
public class DateFormatUtils {
    ...
    private static final String DATE_FORMAT_PATTERN_YMD_H = "yyyy-MM-dd HH";
    ...
    private static long str2Long(String dateStr, String pattern) {
        try {
            ...
            try {
                return new SimpleDateFormat(DATE_FORMAT_PATTERN_YMD_H, Locale.CHINA).parse(dateStr).getTime();
