package com.rexense.wholehouse.datepicker;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
     ...
     */
    public CustomDatePicker(Context context, Callback callback, String beginDateStr, String endDateStr, boolean showMinute) {
        this(context, callback, DateFormatUtils.str2Long(beginDateStr, true),
                DateFormatUtils.str2Long(endDateStr, true), showMinute);
    }
     ...
     */
    public CustomDatePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp, boolean showMinute) {
