...
public class Constant {
    ...
    // 正式环境APPKEY
    public static final String APPKEY    = "32738005";
    public static final String APPSECRET = "e78086d04b47faa5047fd2f2595fa602";
    ...
    public static final String KEY_NICK_NAME_PK = CTSL.PK_SIX_TWO_SCENE_SWITCH + " , "
            ...
            + CTSL.PK_TWO_SCENE_SWITCH + " , " + CTSL.PK_ONEWAYWINDOWCURTAINS_LF + " , " + CTSL.PK_TWOWAYWINDOWCURTAINS_LF + " , " + CTSL.PK_ANY_TWO_SCENE_SWITCH
            + " , " + CTSL.PK_ANY_FOUR_SCENE_SWITCH + " , " + CTSL.PK_SIX_SCENE_SWITCH_YQS_XB + " , " + CTSL.PK_ONEWAYSWITCH_HY + " , " + CTSL.PK_ONEWAYSWITCH_YQS_XB
            + " , " + CTSL.PK_ONEWAYSWITCH_LF + " , " + CTSL.PK_ONEWAY_DANHUO_RY + " , " + CTSL.PK_TWOWAYSWITCH_HY + " , " + CTSL.PK_TWOWAYSWITCH_YQS_XB
            + " , " + CTSL.PK_TWOWAYSWITCH_LF + " , " + CTSL.PK_TWOWAY_DANHUO_RY + " , " + CTSL.PK_THREEWAYSWITCH_HY
            + " , " + CTSL.PK_THREEWAYSWITCH_YQS_XB + " , " + CTSL.PK_THREEWAYSWITCH_LF + " , " + CTSL.PK_THREEWAY_DANHUO_RY
            + " , " + CTSL.PK_FOURWAYSWITCH_LF + " , " + CTSL.PK_FOUR_SCENE_SWITCH_LF + "," + CTSL.PK_ONEWAYSWITCH_YQS_ZR
            + "," + CTSL.PK_TWOWAYSWITCH_YQS_ZR + " , " + CTSL.PK_THREEWAYSWITCH_YQS_ZR + " , " + CTSL.PK_SIX_SCENE_SWITCH_YQS_ZR
