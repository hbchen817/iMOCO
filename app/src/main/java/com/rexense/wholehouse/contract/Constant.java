...
public class Constant {
    ...
    public static final String KEY_NICK_NAME_PK = CTSL.PK_SIX_TWO_SCENE_SWITCH + " , "
            ...
            + " , " + CTSL.PK_ANY_FOUR_SCENE_SWITCH + " , " + CTSL.PK_SIX_SCENE_SWITCH_YQSXB + " , " + CTSL.PK_ONEWAYSWITCH_HY + " , " + CTSL.PK_ONEWAYSWITCH_YQS
            + " , " + CTSL.PK_ONEWAYSWITCH_LF + " , " + CTSL.PK_ONEWAY_DANHUO_RY + " , " + CTSL.PK_TWOWAYSWITCH_HY + " , " + CTSL.PK_TWOWAYSWITCH_YQS
            + " , " + CTSL.PK_TWOWAYSWITCH_LF + " , " + CTSL.PK_TWOWAY_DANHUO_RY + " , " + CTSL.PK_THREEWAYSWITCH_HY
            + " , " + CTSL.PK_THREEWAYSWITCH_YQS + " , " + CTSL.PK_THREEWAYSWITCH_LF + " , " + CTSL.PK_THREEWAY_DANHUO_RY
            + " , " + CTSL.PK_FOURWAYSWITCH_LF + " , " + CTSL.PK_FOUR_SCENE_SWITCH_LF;
