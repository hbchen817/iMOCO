...
public class CTSL {
    ...
    public static final String PK_DOORSENSOR = "a1cErKvfSFv";// 门磁传感器
    public static final String PK_PIRSENSOR = "a1CzbnRNzCR";
    public static final String PK_REMOTECONTRILBUTTON = "a1G306IUVoa";
    public static final String PK_SMART_LOCK_A7 = "a1Pmh01sy65";//临时密码StartTime
    ...
    public static final String PK_WSD_ELE = "a1aqlH5qWN8";//微仕达电机pk
    ...
    public static final String PK_AIRCOMDITION_TWO = "a1N0PnSSB67";// 空调二管制
    ...
    public static final String TEST_PK_ONEWAYWINDOWCURTAINS = "a1th1FeuVij";// 单路窗帘
    public static final String TEST_PK_TWOWAYWINDOWCURTAINS = "a1cs9K2oE8t";// 双路窗帘

    public static final String TEST_PK_FULL_SCREEN_SWITCH = "a18MYdaR9Cd";// 全面屏开关
