...
public class MoreSubdeviceActivity extends BaseActivity {
    ...
    private void setWheelPicker(int type, String initValue) {
        ...
        // 取消处理
        TextView cancel = findViewById(R.id.oneItemWheelPickerLblCancel);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getIntExtra("owned", 0) == 0) {
            RelativeLayout rlRoom = findViewById(R.id.moreSubdeviceRLRoom);
        ...
        mLblRoomName = findViewById(R.id.moreSubdeviceLblRoom);
        mLblRoomName.setText(mRoomName);
        mLblMACAddress = findViewById(R.id.moreSubdeviceLblMACAddress);
        mLblMACAddress.setText(deviceEntry.deviceName);
        TextView bindTime = findViewById(R.id.moreSubdeviceLblBindTime);
        bindTime.setText(mBindTime);

        // 显示设备名称修改对话框事件处理
        mLblNewNickName = findViewById(R.id.moreSubdeviceLblName);
        mLblNewNickName.setText(mName);
        ImageView inputNickName = findViewById(R.id.moreSubdeviceImgName);
        ...
        ImageView selectRoom = findViewById(R.id.moreSubdeviceImgRoom);
        ...
        TextView lblUnbind = findViewById(R.id.moreSubdeviceLblUnbind);
        ImageView imgUnbind = findViewById(R.id.moreSubdeviceImgUnbind);
        ...
        ImageView imgMessageRecord = findViewById(R.id.moreSubdeviceImgMsg);
